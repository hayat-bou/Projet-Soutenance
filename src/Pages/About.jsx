        ...
        >
          <div className="container mx-auto px-6 relative z-20 text-center">
            <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 animate-fade-in">
              Welcome to <span className="text-orange-300">Happy Paws</span> Shelter 🐾
            </h1>
          ...
          {[1, 2, 3].map((item) => (
            <div key={item} className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-48 bg-gray-200 overflow-hidden">
                <img 
                  src={`/images/success-${item}.jpg`} 
                  alt="Success story" 
                  className="w-full h-full object-cover transition-transform duration-500 hover:scale-110"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Max's Journey</h3>
                <p className="text-gray-600 mb-4">
                  Rescued from neglect, Max found his forever home with the Johnson family.
                </p>
